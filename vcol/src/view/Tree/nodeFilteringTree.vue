...
<div>
    ...
    <el-tree class="filter-tree" accordion :data="data" :props="defaultProps" :filter-node-method="filterNode" ref="tree">
    </el-tree>
    ...
    data() {
        return {
            ...
            textarea2: `
                ...
                <el-tree class="filter-tree" accordion :data="data" :props="defaultProps" default-expand-all :filter-node-method="filterNode" ref="tree">
                </el-tree>
