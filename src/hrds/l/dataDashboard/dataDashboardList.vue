        ...
        <el-table size='medium' :data="dataDashboardList" border style="width: 100%;">
            ...
            <el-table-column label="操作" align="left">
                <template slot-scope="scope">
                    <el-button type="text" size="mini" class="sendcolor" @click="releaseDashboardInfo(scope.row)">发布</el-button>
                    <el-button type="text" size="mini" class="editcolor" @click="goToDashbaord(scope.row)">编辑</el-button>
                    <el-button type="text" size="mini" class="delcolor" @click="deleteDashboardInfo(scope.row)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
    </div>
