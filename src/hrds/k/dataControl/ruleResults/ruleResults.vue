            ...
            <el-row :gutter="20">
                <el-col :span="8">
                    <el-form-item label="检查日期 : " prop='verify_date'>
                        <el-date-picker v-model="rule_result_form.verify_date" placeholder="检查日期" value-format="yyyyMMdd">
                        </el-date-picker>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="执行日期 : " prop='start_date'>
                        <el-date-picker v-model="rule_result_form.start_date" placeholder="执行日期" value-format="yyyyMMdd">
                        </el-date-picker>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
            ...
            <el-row :gutter="20">
                <el-col :span="8">
                    <el-form-item label="执行方式 : " prop='exec_mode'>
                        <el-select v-model="rule_result_form.exec_mode" placeholder="请选择">
                            <el-option v-for="item in exec_mode_list" :key="item.code" :label="item.value" :value="item.code">
                            </el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="检查结果 : " prop='verify_result'>
                        <el-select v-model="rule_result_form.verify_result" multiple placeholder="请选择">
                            <el-option v-for="item in verify_result_list" :key="item.code" :label="item.value" :value="item.code">
                            </el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :span="6">
                    <el-form-item label="规则类型 : " prop='case_type'>
                        <el-select v-model="rule_result_form.case_type" multiple placeholder="请选择">
                            <el-option v-for="i in case_type_list" :key="i.case_type" :value="i.case_type" :label="i.case_type+' : '+i.case_type_desc" />
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :span="2">
...
import * as rcFun from "../ruleConfig/ruleConfig";
    ...
    methods: {
        ...
        getCaseType() {
            rcFun.getDqRuleDef().then(res => {
                this.case_type_list = res.data;
                //处理List为Map
                res.data.forEach(row => {
                    this.case_type_map[row.case_type] = row.case_type_desc;
                });
            })
        },
        //获取规则执行结果数据
