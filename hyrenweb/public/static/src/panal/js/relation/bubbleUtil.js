;(function (factory) {
	...
	/**
	   绘制气泡图，data为气泡显示数据
	*/
	function renderBubbleChart(data, container, textName, echartBackground) {
					
		var chart = echarts.init(container);
											   
		drawChart(chart, processBubbleData(data, container), textName, echartBackground); 
	...
	*/
	function drawChart(chart, bubbleData, textName, echartBackground) {			    											
		var option = {
			 backgroundColor: echartBackground,
			 title: textName,
			 tooltip: {
				show: true,
				triggerOn: 'none',
