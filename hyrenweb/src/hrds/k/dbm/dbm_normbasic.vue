<template>
    <div id='nameTable'>
            ...
            <el-col :span='18' style="border-left: 1px #e0dcdc dashed;min-height: 400px;">
                <el-row style="margin-bottom:10px">
                    ...
                    <el-col :span='10' style="text-align:right" class='allbutton'>
                        <el-upload style="display: inline-block;margin-right:10px" :action="uploadUrl()"
                                   accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                                   :limit="1" :show-file-list="false" :file-list="fileList" ref="uploaded"
                                   :on-exceed="exceedHander" :before-upload="beforeAvatarUpload" :auto-upload="false"
                                   :on-change="testOnchange" :on-success="handleSuccess">
                ...
                <el-row>
                    <el-table :data="tableData" border size='medium' style="min-height: 200px;" class='outtable'
                              ref="multipleTable" :row-key="(row)=>{ return row.basic_id}"
                              @selection-change="handleSelectionChange" @filter-change="fulterChangeFun"
                        ...
                        <el-table-column label="发布状态" align="center" width="100" column-key='Releasestatus'
                        ...
                        <el-table-column label="操作" align="center">
                            <template slot-scope="scope">
                                <el-button type="text" size="small" class='editcolor'
                                           @click="editbasicByIdFun(scope.row)">编辑
                                </el-button>
                                <el-button type="text" size="small" class='issuecolor' @click="issueFun(scope.row)">发布
                                </el-button>
                                <el-button type="text" size="small" class='delcolor'
                                           @click="deleteDbbasicInfo(scope.row)">删除
                                </el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                                ...
                                <el-col :span="7">
                                    <el-row>
                                        <el-form-item label="归属分类 : " prop="belongsClass" :rules="rule.selected">
                                            <el-cascader :options="options" filterable clearable size='mini'
                                                         :show-all-levels="false" v-model="ruleForm_Info.belongsClass"
                                                         clearable :props="SetKesDept"></el-cascader>
                                        </el-form-item>
                                    </el-row>
                                </el-col>
                            </el-row>
                                    ...
                                    <el-row>
                                        <el-form-item label="数据类型 : " prop="data_types">
                                            <el-select placeholder="请选择" size="mini" v-model="ruleForm_Info.data_types">
                                                <el-option size="mini" v-for="item in dataType" :key="item.code"
                                    ...
                                    <el-row>
                                        <el-form-item label="所属代码 : " prop="belongsCode">
                                            <el-select placeholder="请选择" size="mini"
                                                ...
                                                <el-option v-for="item in dbmCodeTypeInfos" :key="item.code_type_id"
                                                           :label="item.code_type_name" :value="item.code_type_id"
                            ...
                            <el-row :gutter="20" style="margin-left:0;margin-bottom:18px">
                                <el-col>
                                    <el-form-item label="值域 : " prop="dbm_domain"
                                                  :rules="filter_rules([{required: true}])">
                                        <el-input type="textarea" :rows="2" v-model="ruleForm_Info.dbm_domain"
                                                  placeholder="请输入内容" style='width:86%'>
                                        </el-input>
                                    </el-form-item>
                                </el-col>
                                ...
                                <el-col :span='7'>
                                    <el-row>
                                        <el-form-item label="发布状态 : " prop="norm_status" :rules="rule.selected">
                                            <el-select placeholder="请选择" size='mini'
                                                       v-model="ruleForm_Info.norm_status">
                                                <el-option v-for="item in Releasestatus" :key="item.value"
                                    ...
                                    <el-row>
                                        <el-form-item label="相关标准 : " prop="relatedStandards">
                                            <el-select placeholder="请选择" size='mini'
                                                ...
                                                <el-option v-for="item in dbmNormbasicInfos" :key="item.value"
                                                           :label="item.norm_cname" :value="item.norm_cname">
                                                </el-option>
                                            </el-select>
                                        </el-form-item>
                                    </el-row>
        ...
        <!-- 导入用户 弹窗二次确认 -->
        <el-dialog title="导入Excel" :visible.sync="importUserDialog" width="550px" :close-on-click-modal="false"
                   :before-close="handleFirst1">
