    ...
    export default {
        ...
        data() {
            return {
                ...
                //页面初始化数据
                form_dq_result: {
                    task_id: 0, reg_num: 0, reg_name: '', case_type: '', exec_mode: '', verify_date: '', target_tab: '',
                    target_key_fields: '', verify_result: '', start_date: '', start_time: '', end_date: '',
                    end_time: '', elapsed_ms: '', is_saveindex1: '0', is_saveindex2: '0', is_saveindex3: '0',
                    check_index1: '', check_index2: '', check_index3: '',
                },
                check_index3_list: [],
                dq_result_s: [],
                task_id: '',
                dq_rule_def_map: {case_type: '', case_type_desc: ''},
                exec_mode_map: {},
                verify_result_map: {},
            }
        },
        ...
        methods: {
            ...
            //获取规则检测结果信息
            getRuleDetectDetail() {
                rrFun.getRuleDetectDetail({'task_id': this.task_id}).then(res => {
                    if (res.success) {
            ...
            getCheckIndex3(task_id) {
                rrFun.getCheckIndex3({'task_id': task_id}).then(res => {
                    if (res.success) {
