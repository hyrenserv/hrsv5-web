                    ...
                    <el-tab-pane label="源数据列表" name="mdm">
                        <div class="mytree">
                            ...
                            <el-tree class="filter-tree" :data="mdmTreeList" :indent="0" @node-click="mdmHandleClick"
                                     @node-contextmenu="MDMRightMouseClick" :filter-node-method="filterNode" ref="tree1">
                    ...
                    <el-tab-pane label="数据回收站" name="drb">
                        <div class="mytree">
                            ...
                            <el-tree class="filter-tree" :data="drbTreeList" :indent="0" @node-click="drbHandleClick"
                                     @node-contextmenu="DRBRightMouseClick" :filter-node-method="filterNode" ref="tree2">
            ...
            <el-col :span="17">
                ...
                <el-row>
                    ...
                    <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage"
                                   ...
                                   :total="data_meta_info.column_info_list.length"></el-pagination>
                </el-row>
            </el-col>
        </el-row>
        <!--源数据列表右键弹框-->
