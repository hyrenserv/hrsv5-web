        ...
        <el-table :data="tableData" border stripe size="medium">
            ...
            <el-table-column label="结果1" align="center">
                <template slot-scope="scope">
                    <el-row>
                        <el-col :span="2">
                            <el-radio v-model="scope.row.radio" :label='scope.row.predict[0][0].standard_id' @change="clickRadioFun(scope.row.predict[0][0].standard_id,scope.row.id)">&nbsp;</el-radio>
                        </el-col>
                        <el-col :span="18">
            ...
            <el-table-column prop="result2" label="结果2" align="center">
                <template slot-scope="scope">
                    <el-col :span="2">
                        <el-radio v-model="scope.row.radio" name="nature" :label='scope.row.predict[1][0].standard_id' @change="clickRadioFun(scope.row.predict[1][0].standard_id,scope.row.id)">&nbsp;</el-radio>
                    </el-col>
                    <el-col :span="18">
            ...
            <el-table-column prop="result3" label="结果3" align="center">
                <template slot-scope="scope">
                    <el-col :span="2">
                        <el-radio v-model="scope.row.radio" :label='scope.row.predict[2][0].standard_id' @change="clickRadioFun(scope.row.predict[2][0].standard_id,scope.row.id)">&nbsp;</el-radio>
                    </el-col>
                    <el-col :span="18">
        ...
        <div id='nameTable'>
            <el-row :gutter='20'>
                ...
                <el-col :span='18' style="border-left: 1px #e0dcdc dashed;min-height: 400px;">
                    ...
                    <el-row>
                        <el-table :data="tableData2" border size='medium' style="min-height: 200px;" class='outtable' ref="multipleTable" :row-key="(row)=>{ return row.basic_id}">
...
export default {
    ...
    methods: {
        tsb_resultFun() {
            console.log(this.tableData)//获取tableData中的radio值和peo值即是选中的值和类型
        },
        dialogDbFun(id) {
            this.dbid = id
