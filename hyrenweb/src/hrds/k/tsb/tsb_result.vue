    ...
    <el-row class="partTwo">
        <el-table :data="tableData" border stripe size="medium">
            ...
            <el-table-column label="结果1" align="center">
                <template slot-scope="scope">
                    <el-col :span="2">
                        <el-radio v-model="scope.row.radio" :label='scope.row.predict[0].result_id' @change="clickRadioFun(scope.row.col_id,scope.row.predict[0].result_id)">
                            &nbsp;
                        </el-radio>
                    </el-col>
                    <el-col :span="18">
            ...
            <el-table-column prop="result2" label="结果2" align="center">
                <template slot-scope="scope">
                    <el-col :span="2">
                        <el-radio v-model="scope.row.radio" :label='scope.row.predict[1].result_id' @change="clickRadioFun(scope.row.col_id,scope.row.predict[1].result_id)">
                            &nbsp;
                        </el-radio>
                    </el-col>
                    <el-col :span="18">
            ...
            <el-table-column prop="result3" label="结果3" align="center">
                <template slot-scope="scope">
                    <el-col :span="2">
                        <el-radio v-model="scope.row.radio" :label='scope.row.predict[2].result_id' @change="clickRadioFun(scope.row.col_id,scope.row.predict[2].result_id)">
                            &nbsp;
                        </el-radio>
                    </el-col>
                    <el-col :span="18">
...
export default {
    ...
    created() {
        ...
        this.getPredictResult(this.detect_id)
    },
    mounted() {
