                ...
                <template scope="scope">
                    <el-row>
                        <el-col :span="24" class="delbtn">
                            <el-button style="color:red" type="text" circle @click="DelRowFun(scope.$index, table_zfth)">删除</el-button>
                        </el-col>
                    </el-row>
                </template>
            </el-table-column>
                ...
                <el-table :data="allTableCleanSettingData.slice((allTableCleanSetData_currentPage - 1) * allTableCleanSetData_pagesize, allTableCleanSetData_currentPage * allTableCleanSetData_pagesize)" border size="medium" highlight-current-row>
                    ...
                    <el-table-column label="操作" width="160px" align="center">
                        <template scope="scope">
                            <el-row>
                                <el-col :span="24" class="delbtn">
                                    <el-button style="color:red" type="text" circle @click="DelRowFun(scope.$index, allTableCleanSettingData)">删除</el-button>
                                </el-col>
                            </el-row>
                        </template>
                    </el-table-column>
        ...
        <el-table :data="Col_zfth" border size="medium" highlight-current-row>
            ...
            <el-table-column label="操作" width="160px" align="center">
                <template scope="scope">
                    <el-row>
                        <el-col :span="24" class="delbtn">
                            <el-button style="color:red" type="text" circle @click="DelRowFun(scope.$index, Col_zfth)">删除</el-button>
                        </el-col>
                    </el-row>
                </template>
            </el-table-column>
        ...
        <el-table :data="Col_colcf" border size="medium" highlight-current-row>
            ...
            <el-table-column label="操作" align="center">
                <template scope="scope">
                    <el-row>
                        <el-col :span="24" class="delbtn">
                            <el-button style="color:red" type="text" circle @click="Col_colcfDelFun(scope.$index, Col_colcf)">删除</el-button>
                        </el-col>
                    </el-row>
                </template>
            </el-table-column>
        ...
        <el-table :data="columnMerge" border size="medium" highlight-current-row :empty-text="tableloadingInfo">
            ...
            <el-table-column label="操作" width="160px" align="center">
                <template scope="scope">
                    <el-row>
                        <el-col :span="24" class="delbtn">
                            <el-button style="color:red" size="medium" type="text" circle @click="columnMergeDelFun(scope.$index,columnMerge)">删除</el-button>
                        </el-col>
                    </el-row>
                </template>
            </el-table-column>
