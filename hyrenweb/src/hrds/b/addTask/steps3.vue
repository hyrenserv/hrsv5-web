<template>
  <div>
    <div class="cleanbtn">
      <el-button size="mini" type="success" @click="allTableSeparatorSettings=true" class="alltables">所有表分隔符设置</el-button>
    </div>
    <el-table
    ...
    >
      ...
      <el-table-column prop="tableName" label="表名" width="175" align="center">
        <template>
          <span>表名</span>
        </template>
      </el-table-column>
      <el-table-column prop="tableChName" label="表中文名" width="175" align="center">
        <template>
          <span>表中文名</span>
        </template>
      </el-table-column>
...
export default {
  data() {
    return {
      allTableSeparatorSettings: false,
