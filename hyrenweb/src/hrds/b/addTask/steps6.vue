                    ...
                    <el-form-item label="调度频率" prop="Dispatching_frequency">
                        <el-col :span="16">
                            <el-select style="width:100%" v-model="ruleForm.Dispatching_frequency" placeholder="频率选择" clearable size="medium" @change="Dispatching_frequencyFun">
                                <el-option v-for="item in Dispatch_Frequency" :key="item.value" :label="item.value" :value="item.code"></el-option>
                            </el-select>
                        </el-col>
                    </el-form-item>
                </el-col>
            ...
            <el-row type="flex" justify="center">
                    ...
                    <el-form-item label="调度触发方式" prop="Dispatching_mode">
                        <el-col :span="16">
                            <el-select style="width:100%" v-model="ruleForm.Dispatching_mode" @change="Dispatching_modeFun" placeholder="调度触发方式选择" clearable>
                                <el-option v-for="item in Dispatching_mode" :key="item.value" :label="item.value" :value="item.code"></el-option>
                            </el-select>
                        </el-col>
                    </el-form-item>
                </el-col>
                <el-col :span="8" v-if="ruleForm.Dispatching_mode=='T'||ruleForm.Dispatching_mode=='Z'">
                    <el-form-item label="调度触发时间" prop="Dispatching_time">
                        <el-col :span="16">
                            <el-time-picker style="width:100%" v-model="ruleForm.Dispatching_time" @change="getDispatching_timeFun" :picker-options="{selectableRange: '00:00:00 - 23:59:59'}" placeholder="调度时间 hh:mm:ss" value-format="HH:mm:ss" format="HH:mm:ss"></el-time-picker>
                        </el-col>
                    </el-form-item>
                </el-col>
                <el-col :span="8" v-else-if="ruleForm.Dispatching_mode=='D'">
                    <el-form-item label="上游作业" prop="Upstream_operation">
                        <el-col :span="16">
                            <el-select style="width:100%" filterable v-model="ruleForm.Upstream_operation" multiple placeholder="上游作业" @focus="getPreJobName" @change="getUpstream_operationFun">
            ...
            <el-row type="flex" justify="center">
                <el-col :span="10">
                    <el-form-item label="作业程序目录" prop="work_path" :rules="rule.default" class="ml_lable">
                        <el-col :span="24">
                            <el-input v-model="ruleForm.work_path" placeholder="作业程序目录" size="medium"></el-input>
                        </el-col>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="日志目录" prop="log_path" :rules="rule.default" class="ml_lable">
                        <el-col :span="24">
                            <el-input v-model="ruleForm.log_path" placeholder="日志目录" size="medium"></el-input>
                        </el-col>
                    </el-form-item>
                </el-col>
                ...
                <el-table-column label="调度触发时间" align="center">
                    <template slot-scope="scope">
                        <el-form-item :prop="'startuptableData.'+scope.$index+'.disp_time'" :rules="rule.default" v-if="scope.row.disp_type==='T'||scope.row.disp_type==='Z'">
                            <el-time-picker style="width:100%" v-model="scope.row.disp_time" size="mini" :picker-options="{selectableRange: '00:00:00 - 23:59:59'}" placeholder="hh:mm:ss" value-format="HH:mm:ss" format="HH:mm:ss"></el-time-picker>
                        </el-form-item>
                    </template>
                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        getPreJobName() {
            let arr = [];
            if (
                this.ruleForm.Project_num != undefined &&
