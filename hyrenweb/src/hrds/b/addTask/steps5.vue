  ...
  <div>
    ...
    >
      ...
      <el-table-column prop="tableName" label="表名" width="150" align="center">
        <template>
          <el-input
            size="medium"
            v-model="ex_destinationData.dataColumnSeparator"
            style="width:120px"
          ></el-input>
        </template>
      </el-table-column>
      <el-table-column prop="tableChName" label="表中文名" width="150" align="center">
        <template>
          <el-input
            size="medium"
            v-model="ex_destinationData.dataColumnSeparator"
      ...
      <el-table-column prop="onlyExtraction" label=" 选择目的地" width="130" align="center">
        ...
        <template>
          <el-checkbox @change="dialogChooseDestination=true"></el-checkbox>
        </template>
      </el-table-column>
      <el-table-column prop="onlyExtraction" label=" 是否拉链存储" width="130" align="center">
        <template slot="header">
          <el-checkbox>
      ...
      <el-table-column prop="extractionDataType" label=" 存储方式" width="180" align="center">
        <template slot="header">
          <el-checkbox>
        ...
        <el-select
          placeholder="存储方式"
          v-model="ex_destinationData.extractionDataType"
          style="width:150px"
          size="medium"
        >
      ...
      <el-table-column prop="onlyExtraction" label=" 数据保留天数" width="120" align="center">
        <template>
          <el-checkbox></el-checkbox>
        </template>
      </el-table-column>
    ...
    <el-dialog title=" 选择目的地" :visible.sync="dialogChooseDestination" width="70%" class="alltable">
      ...
      >
        ...
        <el-table-column property="Storagename" label="存储名称" align="center"></el-table-column>
        <el-table-column property="Storage" label="存储" align="center"></el-table-column>
    ...
    <!-- 配置字段属性 -->
     <el-dialog :visible.sync="dialogFieldProperty" width="70%" class="alltable">
      ...
      <el-button
        ...
        class="addline"
      >新增行</el-button>
      <el-table :data="FieldProperty.slice((fieldProperty_currentPage - 1) * fieldProperty_pagesize, fieldProperty_currentPage * fieldProperty_pagesize)"
