<template>
    <div class="visualizationDiv">
        ...
        <div class="lines"></div>
        <el-row>
            <el-select v-model="formvalue" placeholder="请选择表单" size="small" style="width:160px" clearable
            ...
            <el-button @click="showDataCollect" type="primary" size="small">
                查看
            </el-button>
        </el-row>
        <el-row>
                            ...
                            <el-tabs type="border-card" size="mini" style="margin-top:0px;">
                                <el-tab-pane label="横轴">
                                    <div style="height:240px;overflow:auto;">
                                        ...
                                        <div style="width:100%;height:34px;margin-bottom:6px;  position: relative;">
                                            ...
                                            <el-input v-model="xAxis.offset" placeholder="轴偏移量" size="small"
                                                      class="selectPosition">
                                            </el-input>
                                        </div>
                                        <div style="width:100%;height:34px;margin-bottom:6px;  position: relative;">
                                ...
                                <el-tab-pane label="纵轴">
                                    <div style="height:240px;overflow:auto;">
                                        ...
                                        <div style="width:100%;height:34px;margin-bottom:6px;  position: relative;">
                                            <span class="el-input-group__prepends">轴偏移量</span>
                                            <el-input v-model="yAxis.offset" placeholder="轴偏移量" size="small"
                                                      class="selectPosition">
                                            </el-input>
                                        </div>
                                        <div style="width:100%;height:34px;margin-bottom:6px;  position: relative;">
