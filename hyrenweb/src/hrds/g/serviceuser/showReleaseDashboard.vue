       ...
       <!--仪表板展示-->
            <div v-show="picshow" id="mydiv">
                <grid-layout :style="layout.length>0 ? grid_layout_backgroundcolor : 'background-color:#FFFFFF'"
                             ...
                             :col-num="120" :row-height="15" :layout.sync="layout"
                    ...
                    <grid-item style="background-color:transparent;border: 0px;" name="pic" v-for="item in layout"
                               ...
                               :type="item.type" @resized="resizedEvent">
...
<script>
    ...
    import * as generatepic from "../../l/generatePic/generatePic";
    import * as drawLine from "../../l/generatePic/line";
    import * as drawBarChart from "../../l/generatePic/barChart";
    import * as drawStackingBarChart from "../../l/generatePic/stackingBarChart";
    import * as drawPolarBarChart from "../../l/generatePic/polarBarChart";
    import * as drawPieChart from "../../l/generatePic/pieChart";
    import * as drawScatterChart from "../../l/generatePic/scatterChart";
    import * as drawBlChart from "../../l/generatePic/blChart";
    import * as drawBlSimpleChart from "../../l/generatePic/blSimpleChart";
    import * as drawTreeMapChart from "../../l/generatePic/treeMapChart";
    import * as drawMapChart from "../../l/generatePic/mapChart";
...
<style scoped>
    ...
    @import '../../l/dataDashboard/css/tpl1.css';
    @import '../../l/dataDashboard/css/tpl2.css';
    @import '../../l/dataDashboard/css/tpl3.css';
    @import '../../l/dataDashboard/css/tpl4.css';
    @import '../../l/dataDashboard/css/tpl5.css';
    .el-input {
        width: 360px;
    }
