    ...
    <el-tabs type="border-card" @tab-click="handleClick">
        <el-tab-pane label="接口信息">
            <el-row :gutter="10">
                <el-col :span="8">
                    <span>有效日期：
                        <el-date-picker type="date" placeholder="结束日期" value-format="yyyyMMdd" v-model="use_valid_date" size="small" />
                    </span>
                </el-col>
                <el-col :span="8">
                    <span>用户选择：
                ...
                <el-col :span="8">
                    <el-button type="success" size="mini" icon="el-icon-search" @click="searchInterfaceInfoByIdOrDate">查询
                    </el-button>
                    <el-button type="danger" size="mini" icon="el-icon-refresh" @click="resetInterfaceTable">重置
                    </el-button>
                </el-col>
            </el-row>
            <!--接口信息列表展示-->
            <el-table :data="interfaceData.slice((currPage - 1) * pageSize,currPage * pageSize)" border style="width: 100%" size="medium">
                ...
                <el-table-column label="操作" align="left" width="130px">
                    <template slot-scope="scope">
                        ...
                        <el-button size="mini" type="text" class='editcolor' @click="searchInterfaceUseInfoById(scope.row)">
                            编辑
                        </el-button>
                        <el-button size="mini" type="text" class='delcolor' @click="deleteInterfaceUseInfo(scope.row)">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-tab-pane label="数据表信息">
            <el-row style="margin-bottom:10px">
                ...
                <el-col :span="8">
                    <el-button type="success" size="mini" icon="el-icon-search" @click="searchTableDataById">查询
                    </el-button>
                    <el-button type="danger" size="mini" icon="el-icon-refresh" @click="resetDataTable">重置
                    </el-button>
                </el-col>
            </el-row>
            <el-table :data="dataTableData.slice((currPage - 1) * pageSize,currPage * pageSize)" border style="width: 100%" size="medium">
                ...
                <el-table-column label="操作" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button size="mini" type="text" class='delcolor' @click="deleteDataTableUseInfo(scope.row)">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
    ...
    <el-dialog title="接口修改" :visible.sync="dialogUpdateFormVisible" :before-close="beforeUpdateClose">
        <el-form :model="form" ref="form" label-width="120px">
            <el-form-item label="开始日期:" prop="start_use_date" :rules="filter_rules([{required: true}])">
                <el-date-picker type="date" placeholder="开始日期" value-format="yyyyMMdd" v-model="form.start_use_date" size="small" />
            </el-form-item>
            <el-form-item label="有效截止日期:" prop="use_valid_date" :rules="filter_rules([{required: true}])">
                <el-date-picker type="date" placeholder="有效截止日期" value-format="yyyyMMdd" v-model="form.use_valid_date" size="small" />
            </el-form-item>
        </el-form>
