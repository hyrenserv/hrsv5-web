    ...
    <el-dialog title="前置作业" :visible.sync="ifprejob" width="80%">
        ...
        <el-row>
            ...
            <el-tabs type="card">
                <el-row>
                    <div style="border:1px solid #ccc;">
                        <SqlEditor ref="sqleditorpre" :data="2" :value="preJobForm.sqlMain" @changeTextarea="changeTextareaPreSql($event)" class='textasql' />
                    </div>
                </el-row>
            </el-tabs>
            <!--</el-col>-->
    ...
    <el-dialog title="后置作业" :visible.sync="ifafterjob" width="80%">
        ...
        <el-row>
            ...
            <el-tabs type="card">
                <el-row>
                    <div style="border:1px solid #ccc;">
                        <SqlEditor ref="sqleditorafter" :data="3" :value="afterJobForm.sqlMain" @changeTextarea="changeTextareaAfterSql($event)" class='textasql' />
                    </div>
                </el-row>
            </el-tabs>
            <!--</el-col>-->
