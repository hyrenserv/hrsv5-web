    ...
    <el-tabs type="card">
        ...
        <el-row>
            <el-col :span="20">
                ...
                <el-input class="inputframe" v-model="parameter" placeholder="参数如: 自定义名称=123;自定义名称2=456,中间用分号;隔开"></el-input>
            </el-col>
            <el-col :span="3" :offset="1">
                <el-row>
                    <span>日期</span>
                </el-row>
                <el-date-picker class="inputframe" v-model="date" align="right" value-format="yyyyMMdd" placeholder="选择日期"></el-date-picker>
            </el-col>
        </el-row>
    </el-tabs>
    <!--</el-form>-->
