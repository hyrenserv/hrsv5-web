...
<div id="marketIndex">
    ...
    <el-table :data="tableData" border stripe size="medium">
        ...
        <el-table-column prop="store_type" width="202" label="数据存储层配置属性" align="center">
            <template slot-scope="scope">
                <el-button type="info" size="mini" @click="dataSaveConfigure = true;handleEdit(scope.$index, scope.row)">数据存储层配置属性
                </el-button>
            </template>
        </el-table-column>
    </el-table>
    ...
    <el-dialog title="选择已有的工程表" :visible.sync="ifalreadyexisttablename" width="35%">
        <el-table :data="alldatatable_en_name" border stripe size="medium">
            ...
            <el-table-column prop="datatable_en_name" label="表英文名" show-overflow-tooltip align="center"></el-table-column>
        </el-table>
        <el-row>
            <el-button type="primary" size="mini" class="rightbtn" @click="confirmselecttable()">
                确定
            </el-button>
...
export default {
    ...
    mounted() {
        ...
        this.getDmCategoryForDmDataTable();
