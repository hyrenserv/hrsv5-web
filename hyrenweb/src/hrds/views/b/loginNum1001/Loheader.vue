    ...
    <el-dialog title="上传文件" :visible.sync="dialogFormVisibleImport" width="42%">
      <el-form :model="form" >
        <el-form-item label="Agent IP地址 :" :label-width="formLabelWidth">
          <el-input v-model="form.agentIp" autocomplete="off" style="width:284px"></el-input> <el-tooltip class="item" effect="dark" content="要上传的数据源下Agent的IP地址" placement="right"><i class="fa fa-question-circle" aria-hidden="true"></i></el-tooltip>
        </el-form-item>
        <el-form-item label="Agent 端口 :" :label-width="formLabelWidth">
          <el-input v-model="form.agentPort" autocomplete="off" style="width:284px"></el-input><el-tooltip class="item" effect="dark" content="要上传的数据源下Agent的端口" placement="right"><i class="fa fa-question-circle" aria-hidden="true"></i></el-tooltip>
        </el-form-item>
    ...
    <el-dialog title="添加数据源" :visible.sync="dialogFormVisibleAdd" width="40%">
      <el-form :model="form" >
        <el-form-item label=" 数据源编号" :label-width="formLabelWidth">
          <el-input v-model="form.datasource_number" autocomplete="off" placeholder="数据源编号" style="width:284px"></el-input>
        </el-form-item>
        <el-form-item label=" 数据源名称" :label-width="formLabelWidth">
          <el-input v-model="form.datasource_name" autocomplete="off" placeholder="数据源名称" style="width:284px"></el-input>
        </el-form-item>
    ...
    <el-option
      ...
      :value="item.value">
       ...
       <el-form-item label=" 数据源详细描述" :label-width="formLabelWidth">
          <el-input type="textarea" v-model="form.source_remark" autocomplete="off"  placeholder="数据源详细描述" style="width:284px"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
export default {
  ...
  methods:{
    add(){
      console.log(this.form.datasource_number)
